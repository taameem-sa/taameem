      ...
      return ListView.builder(
        ...
        itemBuilder: (_, i) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              color: banned ? AppColors.error.withOpacity(0.06) : AppColors.glassBackground,
              borderRadius: BorderRadius.circular(14),
              border: Border.all(color: banned ? AppColors.error.withOpacity(0.3) : AppColors.glassBorder)),
            child: Row(children: [
              CircleAvatar(radius: 22, backgroundColor: AppColors.emerald.withOpacity(0.1),
              ...
              if (role == 'user')
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: banned ? AppColors.emerald.withOpacity(0.1) : AppColors.error.withOpacity(0.1),
                      borderRadius: BorderRadius.circular(8),
                      border: Border.all(color: banned ? AppColors.emerald.withOpacity(0.3) : AppColors.error.withOpacity(0.3))),
